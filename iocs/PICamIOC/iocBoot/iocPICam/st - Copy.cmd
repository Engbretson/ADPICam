...
#dbLoadDatabase("$(TOP)/dbd/IMMpluginSupport.dbd")
#dbLoadDatabase("$(TOP)/dbd/immViewPluginSupport.dbd")
...
dbLoadRecords("$(ADCORE/db/NDPluginBase.template","P=$(PREFIX):,R=cam1:,PORT=$(PORT),ADDR=0,TIMEOUT=1,NDARRAY_PORT=$(PORT),NDARRAY_ADDR=0")
dbLoadRecords("./NDFileIMM.template", "P=$(PREFIX),R=cam1:,PORT=Image1,ADDR=0,TIMEOUT=1")
