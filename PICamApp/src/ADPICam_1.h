...
//    int PICAM_SensorActiveWidth;
	...
	// Image offsets in kenics mode differnet from full image values
	int PICAM_ArraySizeK;
	int PICAM_ReadoutStrideK;
...
#define PICAM_ArraySizeKString                  "PICAM_ArraySizeK" 
#define PICAM_ReadoutStrideKString              "PICAM_ReadoutStrideK" 
