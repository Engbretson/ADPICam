...
//    int PICAM_SensorActiveWidth;
	...
	// Don't just change ROI SizeY in kinetics mode, keep it elsewhere
	int PICAM_ADSizeYF;
	int PICAM_InitCam;
	int PICAM_Sizey;
	int PICAM_ArraySizeY;
	int PICAM_ArraySize;

#define PICAM_LAST_PARAM PICAM_ArraySize
...
private:
	...
	asynStatus piInitializeAllCameraParameters();
	asynStatus piTweakROI();
	...
	void ADPICam::ValidateInteger(int ADMode, PicamParameter PicamMode, int& ADValue, int& PiValue);
...
#define PICAM_ADSizeYFString                    "PICAM_ADSizeYF" 

#define PICAM_InitCamString             "PICAM_InitCam" 
#define PICAM_SizeYString               "PICAM_Sizey"
#define PICAM_ArraySizeYString          "PICAM_ArraySizeY"
#define PICAM_ArraySizeString           "PICAM_ArraySize"
